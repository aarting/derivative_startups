...
RSpec.describe NounsController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested noun as @noun" do
      noun = Noun.create! valid_attributes
      get :show, {:id => noun.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested noun as @noun" do
      noun = Noun.create! valid_attributes
      get :edit, {:id => noun.to_param}, valid_session
      expect(assigns(:noun)).to eq(noun)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Noun" do
        expect {
          post :create, {:noun => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved noun as @noun" do
        post :create, {:noun => invalid_attributes}, valid_session
        expect(assigns(:noun)).to be_a_new(Noun)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested noun" do
        noun = Noun.create! valid_attributes
        put :update, {:id => noun.to_param, :noun => new_attributes}, valid_session
        noun.reload
      ...
      it "assigns the requested noun as @noun" do
        noun = Noun.create! valid_attributes
        put :update, {:id => noun.to_param, :noun => valid_attributes}, valid_session
        expect(assigns(:noun)).to eq(noun)
      end
    ...
    describe "with invalid params" do
      it "assigns the noun as @noun" do
        noun = Noun.create! valid_attributes
        put :update, {:id => noun.to_param, :noun => invalid_attributes}, valid_session
        expect(assigns(:noun)).to eq(noun)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested noun" do
      noun = Noun.create! valid_attributes
      expect {
        delete :destroy, {:id => noun.to_param}, valid_session
      }.to change(Noun, :count).by(-1)
    end
